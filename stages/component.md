...
| `ddd.md` | 领域设计 | Backend 模式 | 每个限界上下文独立维护边界、统一语言、领域模型图、状态图、关键时序图和领域事件 |
...
- 每个限界上下文必须完整包含边界、统一语言、领域模型图、状态图、关键时序图和领域事件列表；
  各上下文独立维护自己的术语、模型、生命周期、协作和事件。领域模型图必须表达
...
- Backend 模式下，`ddd.md` 的每个限界上下文完整记录边界、统一语言、领域模型、状态图、关键时序图
